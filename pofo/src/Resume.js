    ...
    return(
        <div className='resume-content'>
            ...
            <div className='resume-banners'>
                <ResumeBanner image={Amazon} company={"Amazon"} position={"Software Engineer"} text={"Software development engineer on the entertainment team in Seattle, WA"}/>
                ...
                <ResumeBanner image={Brown} company={"Brown University"} position={"Teaching Assistant"} text={"Computational Linguistics: Developed projects focused on natural language processing such as transformers, sentiment analysis and machine translation. Computer Vision: Implementing new workshops teaching feature detection, 3D image reconstruction, and convolutional neural networks. Introduction to Engineering: Mentored students in human-centered design and technical machine proficiency"}/>
                ...
                <ResumeBanner image={HMS} company={"Harvard University"} position={"Research Assistant"} text={"Analyzed correlations between neurological activity and physical behavior in rats by designing a neural network to identify unmarked 3D rat joints using spatial, temporal, and behavioral data with 80% accuracy. Predicted coordinates of missing joints with 85% using a variational autoencoder and biomechanics"}/>
                <ResumeBanner image={UCD} company={"UC Davis"} position={"Research Assistant"} text={"Determined optimal cell confluence to grow COVID vaccines, reducing laboratory resources and time by 50%. Analyzed antibody generation efficacy of adenovirus vector vaccines by designing plasmids, growing cell lines, operating flow cytometry, and performing ELISA tests on COVID-infected rhesus macaque blood samples"}/>
